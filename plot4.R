...
par(mfrow=c(2,2))
with(sdf, plot(Time, Global_active_power, type="l", ylab="Global Active Power", xlab=""))
with(sdf, plot(Time, Voltage, type="l", xlab="datetime"))
...
with(sdf, plot(Time, Global_reactive_power, type="l", xlab="datetime"))
